...
docker compose logs --tail=120 botmusica postgres
```
...
- O deployment usa `botmusica:latest`.
- O script faz `rollout restart` para forcar atualizacao do pod mesmo com a mesma tag.
...
Script opcional para validar `botmusica + postgres`:
